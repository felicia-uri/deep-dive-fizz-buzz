...
/**
 * This class implements the FizzBuzz game, using an upper limit specific on the command line.
 *
...
public class FizzBuzz {
  ...
  /**
   * Counts from 1 to the value specified on the command line (or 100 if not specified), printing
   * out fizz/buzz/fizzbuzz number for each.
   *
  ...
  /**
   * Computes and returns the appropriate fizz/buzz/fizzbuzz/number value for a given input value.
